    ...
    <Layout className="bg-gray-900 h-auto" windowSize={windowSize}>
      <Header className="bg-base-200" full={true}>
        <div className="absolute h-full -left-14 sm:-left-8 md:-top-20 pt-0 px-0">
          <h2
            className="font-title font-semibold text-white text-opacity-5 text-60vw sm:text-50vw md:text-40vw leading-none w-full mt-0 mb-6 ml-0 cursor-default z-min"
        ...
        <div className="w-full max-w-200 mx-auto">
          <h1 className="relative inline-block text-6xl font-title font-bold text-white text-opacity-90 leading-none tracking-normal m-0 mt-12 pb-3 transition-all duration-200 ease-in-out md:text-7xl md:mt-6">
            {upperFirst(title)}
            <span className="bg-gradient-to-br from-blue-500 to-indigo-600 bg-clip-text ">
              .
            </span>
          </h1>
          <h2 className="font-sans text-gray-600 text-base text-left font-medium leading-tight w-full mt-1 mb-3 ml-0 mr-auto md:text-lg md:w-9/10 xl:w-4/5">
            Read my latest articles and posts on software development, design,
            technology and more.
          </h2>
        </div>
      </Header>
