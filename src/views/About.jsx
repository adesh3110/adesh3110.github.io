      ...
      <Inner>
        ...
        <div className="flex flex-col md:flex-row items-center mt-0 md:pt-2 px-2">
          ...
          <span className="text-white text-xl font-medium leading-tighter pt-8 hidden md:block md:pt-0 md:pl-10 lg:pl-12 lg:text-2xl xl:text-3xl">
            As a frontend developer with nearly 3 years of experience, I
            specialize in crafting responsive and user-friendly web
            applications. Proficient in HTML, CSS, JavaScript, and modern
            frameworks like React, I focus on creating seamless user
            experiences.
          </span>
        </div>
        <p className="text-gray-700 text-lg lg:text-xl font-sans leading-normal pt-8 md:pt-6 lg:pt-8">
          I'm a frontend engineer with a passion for using technology to create
          unique and memorable experiences. I have experience working in a
          variety of languages, but I'm particularly fond of{'  '}
          <a
