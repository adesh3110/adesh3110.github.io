...
const GatsbyIcon = () => (
  <svg
    ...
    height="32"
    viewBox="0 0 32 32"
    className="inline-block relative fill-current text-gray-600 ml-2"
    style={iconStyle}
  >
    <path
      d="M15.9554.0891A15.9555,15.9555,0,1,0,31.9109,16.0446,15.9555,15.9555,0,0,0,15.9554.0891ZM3.4284,16.2109,15.7891,28.5716A12.528,12.528,0,0,1,3.4284,16.2109ZM18.76,28.2584,3.7416,13.24A12.531,12.531,0,0,1,26.085,8.671L24.35,10.2016a10.23,10.23,0,0,0-18.0141,2.36L19.438,25.6638a10.249,10.249,0,0,0,6.4484-7.1646H20.4557V16.0446h8.0289A12.5338,12.5338,0,0,1,18.76,28.2584Z"
      transform="translate(0 -0.0891)"
    />
  </svg>
);
...
const Footer = () => {
  ...
  return (
    <footer
      className="relative flex w-full justify-center items-center -mt-16 py-16 lg:py-24 z-999"
      role="contentinfo"
    >
      ...
      <FooterWrapper className="relative font-sans text-xxs text-gray-600 text-center top-10 sm:top-14 md:top-16 lg:top-24 p-6 px-4 z-9999">
        <ul className="list-reset text-3xl mt-0 mb-4`">
          ...
          />
          <SocialLink
            link="https://www.linkedin.com/in/adesh-singh-07312b147/"
        ...
        <div className="flex text-sm items-center align-middle pt-2">
          ...
          <Circle className="relative w-1 my-0 mx-2" size="1em" />
          <span className="flex items-center align-middle">
            Template Inspired by : <p className="gradient-text-green"> Brett</p>
          </span>
        </div>
      </FooterWrapper>
    </footer>
