...
const Code = () => (
  <CodeWrapper className="relative w-full justify-center items-center top-16 -left-28 md:top-6 md:-left-16 xl:left-0 py-6 md:py-8 lg:py-24 z-5">
    <svg
      ...
      viewBox="0 0 210 168"
      className="code-svg text-white w-40 h-40 top-18 right-0 sm:top-22 sm:right-10 md:w-64 md:h-64 md:top-24 md:left-104 lg:w-68 lg:h-68 lg:top-28 m-0 ml-2 z-0"
    >
...
const ScrollArrow = ({ location }) => (
  <div className="relative text-center w-1/2 top-0 sm:-top-8 mx-auto my-2 mt-18 md:mt-6 xl:mt-2">
